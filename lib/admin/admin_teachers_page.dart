            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snap) {
                ...
                final filtered = docs.where((d) {
                  ...
                  return fullName.contains(q) || username.contains(q) || classId.contains(q);
                }).toList();
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDetailRow("Clasa reprezentată", classId.isEmpty ? "Nespecificată" : classId),
                                ...
                                onPressed: busy ? null : () async {
                                  final ok = await showDialog<bool>(
                                    ...
                                    builder: (_) => AlertDialog(
                                      ...
                                      content: Text("Sigur dorești să ștergi profesorul: $username?"),
                                      actions: [
